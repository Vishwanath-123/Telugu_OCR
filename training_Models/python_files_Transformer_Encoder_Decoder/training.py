from Decoders import Decoder_Trans_Encoder, Decoder_Trans_Decoder
...
# Decoder = Decoder_Trans_Encoder().to(device)
Decoder = Decoder_Trans_Decoder().to(device)
...
optimizer = torch.optim.Adam(params, lr=5e-3, weight_decay=1e-9)
# SGD optimizer
...
for epoch in range(1, num_of_epochs + 1):
    ...
    if epoch%20 == 0:
        torch.save(Encoder.state_dict(), "/home/ocr/teluguOCR/Models/Best_CNN/TDE/Model" + str(save_num) + ".pth")
        torch.save(Decoder.state_dict(), "/home/ocr/teluguOCR/Models/Best_RNN/TDE/Model" + str(save_num) + ".pth")
        save_num += 1

# saving the losses into a pt file
torch.save(torch.tensor(Losses), "/home/ocr/teluguOCR/Losses/Training_TDE.pt")
torch.save(torch.tensor(val_losses), "/home/ocr/teluguOCR/Losses/Validation_TDE.pt")
...
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.savefig("/home/ocr/teluguOCR/Losses/Losses_TDE.png")      